...
import com.example.mpchart.interfaces.dataprovider.BarLineScatterCandleBubbleDataProvider;
import com.example.mpchart.interfaces.datasets.IBarLineScatterCandleBubbleDataSet;
import com.example.mpchart.jobs.AnimatedMoveViewJob;
import com.example.mpchart.jobs.AnimatedZoomJob;
import com.example.mpchart.jobs.MoveViewJob;
import com.example.mpchart.jobs.ZoomJob;
import com.example.mpchart.listener.BarLineChartTouchListener;
import com.example.mpchart.listener.OnDrawListener;
import com.example.mpchart.renderer.XAxisRenderer;
import com.example.mpchart.renderer.YAxisRenderer;
import com.example.mpchart.utils.MPPointD;
...
public abstract class BarLineChartBase<T extends BarLineScatterCandleBubbleData<? extends
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isClipValuesToContentEnabled()) {
            ...
            mRenderer.drawValues(canvas, mIndicesToHighlight);
